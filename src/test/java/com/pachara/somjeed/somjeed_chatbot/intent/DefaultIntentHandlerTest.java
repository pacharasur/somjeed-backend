...
class DefaultIntentHandlerTest {
    ...
    void handle_shouldMapCheckBalance() {
        ...
        List<String> response = handler.handle(IntentTypeEnum.CHECK_BALANCE, context);
